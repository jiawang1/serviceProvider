(function() {
  ...
  $(function() {
    $('#server-submit').on('click', function(e) {
      ...
      $.post('/__server_config__/save_server_config', val, function(data) {
        console.log(data);
      });
    });
    ...
    $('table').on('click', '.delete', function(e) {
      ...
      $.post(
        '/__server_config__/delete_service_config',
        {
          serviceUrl: $targetTd
            .siblings('.service-url')
            .text()
            .trim(),
          serviceMethod: $targetTd
            .siblings('.service-method')
            .text()
            .trim(),
          serviceParam: $targetTd
            .siblings('.service-param')
            .text()
            .trim()
        },
        function(data) {
    ...
    $('table').on('click', '.edit', function(e) {
      var $targetTd = $(e.currentTarget).parent();
      $.get(
        '/__server_config__/load_service',
        {
          serviceUrl: $targetTd
            .siblings('.service-url')
            .text()
